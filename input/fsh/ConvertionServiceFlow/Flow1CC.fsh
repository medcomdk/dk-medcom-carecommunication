...
* entry[+].fullUrl = "https://medcomfhir.dk/ig/carecommunication/Communication/71cf30a1-9186-42cc-a805-76fa611c82e9"
* entry[=].resource = 71cf30a1-9186-42cc-a805-76fa611c82e9
* entry[+].fullUrl = "https://medcomfhir.dk/ig/carecommunication/Encounter/fd75f522-f40c-4762-bbea-17facaed105b"
...
* entry[=].resource = ffad2ed6-9c5c-4eaa-9cb9-039d82dc64ce
//https://medcomfhir.dk/ig/carecommunication/
...
* focus = Reference(71cf30a1-9186-42cc-a805-76fa611c82e9)
* definition = "http://medcomfhir.dk/ig/carecommunication/medcom-careCommunication-message-definition|4.0.0"


// Rettet + tjekket
Instance: 71cf30a1-9186-42cc-a805-76fa611c82e9
...
* encounter = Reference(fd75f522-f40c-4762-bbea-17facaed105b)
...
* entity[payload][0].what.identifier.value = "urn:uuid:1a7544c5-b95b-4fed-96f9-07036496ae5d"
* entity[payload][1].role = #source
* entity[payload][1].what.identifier.value = "urn:uuid:c39ea6b2-6052-45e4-a207-415e0205ab6f"
...
* name.family = "MedCom testcenter" //RCH: Skal vi ikke give ham/hende et rigtigt navn i stedet?
...
//Rettet + tjekket
Instance: fd75f522-f40c-4762-bbea-17facaed105b
InstanceOf: MedComCoreEncounter
Title: "CareCommunication Flow 1 Encounter"
Description: "CareCommunication Flow 1 Encounter"
* status = $StatusCodes#unknown 
* class = $ActCodes#other 
* subject = Reference(3228c610-8f13-453d-8d9c-488372752390)
//RCH: Hvorfor har vi encounter uden noget forløbs-id?