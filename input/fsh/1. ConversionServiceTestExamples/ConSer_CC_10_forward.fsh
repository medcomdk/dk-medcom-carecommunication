...
Title: "ConSer_CC_10_forward - Forward CareCommunication message"
...
Title: "ConSer_CC_10_forward - Instance of a MessageHeader resource used in a forward message."
Description: "ConSer_CC_10_forward - Example of a MessageHeader in a forward CareCommunication message. Valid only if used in a bundle (message)."
...
Title: "ConSer_CC_10_forward - Bruno Test Elmer"
Description: "ConSer_CC_10_forward - Patient described with minimal information. Valid only if used in a Bundle."
Usage: #example
...
Title: "ConSer_CC_10_forward Simple practitioner with a name"
Description: "ConSer_CC_10_forward Simple practitioner with a name"
* name.given = "Emma"
* name.family = "Waters"

Instance: 03ce50f2-d7ad-472b-b29c-00880a422fd1
InstanceOf: MedComCorePractitionerRole
Title: "ConSer_CC_10_forward PractitionerRole with a role and reference to a practitioner"
Description: "ConSer_CC_10_forward PractitionerRole with a role and reference to a practitioner"
...
Title: "ConSer_CC_10_forward - Example of a reciever organization with a SOR and an EAN identifier."
Description: "ConSer_CC_10_forward Example of an organization with a SOR and an EAN identifier."
...
InstanceOf: MedComMessagingOrganization // 
Title: "ConSer_CC_10_forward - Example of a sender organization with a SOR and an EAN identifier."
Description: "Example of an organization with a SOR and an EAN identifier."
Usage: #example
...
Title: "ConSer_CC_10_forward Instance of Communication resource used in a forward message."
Description: "ConSer_CC_10_forward - Content of care communication message. Valid only if used in a bundle (message) - forward message"
