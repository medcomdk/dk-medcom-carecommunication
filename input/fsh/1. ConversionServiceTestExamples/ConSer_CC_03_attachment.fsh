...
* timestamp = 2025-09-30T13:00:00+02:00
...
* payload[0].extension[date].valueDateTime = 2025-09-30T13:00:00+02:00
* payload[0].extension[identifier].valueIdentifier.value = "urn:uuid:24d01288-ad36-4af2-96a8-fd1432dadee1"
* payload[0].extension[identifier].valueIdentifier.assigner = Reference(f182838e-96c9-4525-bcc0-a02375f30f2a)
* payload[0].extension[author].valueReference = Reference(2c6cabeb-05d9-4e05-9193-7de0dca5040c)
...
* payload[1].extension[date].valueDateTime = 2025-09-30T13:00:00+02:00
...
InstanceOf: MedComMessagingOrganization  
Title: "ConSer_CC_03_attachment - Example of a receiver organization with a SOR and an EAN identifier."
Description: "ConSer_CC_03_attachment - Example of an organization with a SOR and an EAN identifier."
...
* occurredDateTime = 2025-09-30T13:00:00+02:00
* recorded = 2025-09-30T13:00:00+02:00
...
* entity[payload][+].role = #source
* entity[payload][=].what.identifier.value = "urn:uuid:f3b6f0ec-88b5-4981-9c8b-aa79fa8af9b7"