...
Title: "ConSer_CC_01_reply - Reply CareCommunication message"
Description: "ConSer_CC_01_reply - Example of a reply to a CareCommunication message."
Usage: #example
...
Title: "ConSer_CC_01_reply - Instance of a MessageHeader resource used in a reply message."
Description: "ConSer_CC_01_reply - Example of a MessageHeader in a reply CareCommunication message. Valid only if used in a bundle (message)."
Usage: #example
...
Title: "ConSer_CC_01_reply - The Provenance instance for a reply to a new message"
Description: "ConSer_CC_01_reply - The Provenance instance is only valid if used in a bundle (message)"
Usage: #inline
...
* entity[payload][0].what.identifier.value = "urn:uuid:a9becf76-fc4c-49aa-8a68-6a0584871fcd"

Instance: aab29fb1-7b56-450c-aee8-0d50f40b800e
InstanceOf: MedComCorePatient
Title: "ConSer_CC_01_reply - Example of Patient"
Description: "ConSer_CC_01_reply - Example of Patient"
...
Title: "ConSer_CC_01_reply - Example of a sender organization with a SOR and an EAN identifier."
Description: "ConSer_CC_01_reply - Example of an organization with a SOR and an EAN identifier."
...
InstanceOf: MedComMessagingOrganization  
Title: "ConSer_CC_01_reply - Example of a receiver organization with a SOR and an EAN identifier."
Description: "ConSer_CC_01_reply - Example of an organization with a SOR and an EAN identifier."
...
Title: "ConSer_CC_01_reply - Instance of Communication resource used in a reply message."
Description: "ConSer_CC_01_reply - Content of care communication message. Valid only if used in a bundle (message) - reply message"
