...
* payload[1].contentString = "Vi har modtaget svar på biopsi taget fra jeres patient Kaja Hansen d. 03.01.2025. Resultatet viser ingen tegn på malignitet, men der er tegn på kronisk inflammation.
...
* payload[1].extension[date].valueDateTime = 2025-01-04T14:00:00+01:00
