...
Title: "ConSer_CC_08_reply_attachment - Reply CareCommunication message with attachment"
Description: "ConSer_CC_08_reply_attachment - Example of a reply to a CareCommunication message with attachment"
Usage: #example
...
Title: "ConSer_CC_08_reply_attachment - Instance of a MessageHeader resource used in a reply message."
Description: "ConSer_CC_08_reply_attachment - Example of a MessageHeader in a reply CareCommunication message. Valid only if used in a bundle (message)."
Usage: #example
...
Title: "ConSer_CC_08_reply_attachment - The Provenance instance is only valid if used in a bundle (message) - new message being forwarded"
Description: "ConSer_CC_08_reply_attachment - The Provenance instance is only valid if used in a bundle (message) - new message being forwarded"
...
InstanceOf: MedComCareCommunicationProvenance
Title: "ConSer_CC_08_reply_attachment - The Provenance instance from the answered message"
Description: "ConSer_CC_08_reply_attachment - The Provenance instance from the answered message"
...
Title: "ConSer_CC_08_reply_attachment - Instance of Communication resource used in a reply message."
Description: "ConSer_CC_08_reply_attachment - Content of care communication message. Valid only if used in a bundle (message) - reply message"
...
* payload[2].contentString = "Hej. Dette er en besvarelse, jeg har vedhæftet en fil, for yderligere info se mere i den vedhæftede pdf. / Michael, sygeplejerske"
...
* payload[2].extension[author].valueReference = Reference(b12b5add-695a-43f5-a298-ee5e71d8ecc1)
...
Title: "ConSer_CC_08_reply_attachment - Kaja Test Hansen"
Description: "ConSer_CC_08_reply_attachment - Patient described with minimal information. Valid only if used in a Bundle."
Usage: #example
...
Title: "ConSer_CC_08_reply_attachment - Example of a sender organization with a SOR and an EAN identifier."
Description: "ConSer_CC_08_reply_attachment - Example of an organization with a SOR and an EAN identifier."
Usage: #example
...
InstanceOf: MedComMessagingOrganization // 
Title: "ConSer_CC_08_reply_attachment - Example of a reciever organization with a SOR and an EAN identifier."
Description: "ConSer_CC_08_reply_attachment - Example of an organization with a SOR and an EAN identifier."
...
Title: "ConSer_CC_08_reply_attachment - Simple practitioner with a name"
Description: "ConSer_CC_08_reply_attachment - Simple practitioner with a name"
* name.given = "Michael"
* name.family = "Burns"  

Instance: b12b5add-695a-43f5-a298-ee5e71d8ecc1
InstanceOf: MedComCorePractitionerRole
Title: "ConSer_CC_08_reply_attachment - PractitionerRole with a role and reference to a practitioner"
Description: "ConSer_CC_08_reply_attachment - PractitionerRole with a role and reference to a practitioner"
