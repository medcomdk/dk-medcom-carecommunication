...
Title: "ConSer_CC_04_reply - Reply CareCommunication message with attachment"
Description: "ConSer_CC_04_reply - Example of a reply to a CareCommunication message with attachment"
Usage: #example
...
Title: "ConSer_CC_04_reply - Instance of a MessageHeader resource used in a reply message."
Description: "ConSer_CC_04_reply - Example of a MessageHeader in a reply CareCommunication message. Valid only if used in a bundle (message)."
Usage: #example
...
Title: "ConSer_CC_04_reply - The Provenance instance is only valid if used in a bundle (message) - new message being forwarded"
Description: "ConSer_CC_04_reply - The Provenance instance is only valid if used in a bundle (message) - new message being forwarded"
...
InstanceOf: MedComCareCommunicationProvenance
Title: "ConSer_CC_04_reply - The Provenance instance from the answered message"
Description: "ConSer_CC_04_reply - The Provenance instance from the answered message"
...
Title: "ConSer_CC_04_reply - Instance of Communication resource used in a reply message."
Description: "ConSer_CC_04_reply - Content of care communication message. Valid only if used in a bundle (message) - reply message"
...
Title: "ConSer_CC_04_reply - Kaja Test Hansen"
Description: "ConSer_CC_04_reply - Patient described with minimal information. Valid only if used in a Bundle."
Usage: #example
...
Title: "ConSer_CC_04_reply - Example of a sender organization with a SOR and an EAN identifier."
