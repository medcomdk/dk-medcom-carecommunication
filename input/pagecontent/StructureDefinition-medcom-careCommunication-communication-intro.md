...
Message text must always be included in a CareCommunication, which applies to creating a new message, replying, and forwarding. All previous message segments with message text or all relevant when forwarding must be included in a message when replying and forwarding a message.
