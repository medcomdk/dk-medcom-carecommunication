...
<p>&nbsp;</p>
<div style="color:#6a737d">This is the textual part of the documentation for MedCom’s FHIR standard ‘CareCommunication’ (da: Korrespondancemeddelelse). This documentation provides information about the clinical guidelines for CareCommunication, including the purpose and background for CareCommunication, an illustration of the structure of CareCommunication, requirements and recommendations, and offers guidance on implementation regarding SOR-EDI.
