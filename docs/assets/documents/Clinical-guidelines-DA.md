...
* [4 Krav og anbefalinger til FHIR Korrespondancemeddelelse](#4-krav-og-anbefalinger-til-korrespondancemeddelelsen)
    ...
    * [4.5 Overblik i brugergrænsefladen](#46-overblik-i-brugergrænsefladen)
    * [4.6 Forsendelsesmuligheder og overblik](#45-forsendelsesmuligheder-og-overblik)
...
<figure>
<img src="../images/IllustrationKorrespondance.png" alt="Eksempel på, en korrespondancemeddelese" style="width:30%" id="Fig1">
