...
* [1 Standard documentation](#1-standard-documentation)
  ...
  * [1.4 Mapping betewwn OIOXML Advis and FHIR CareCommunication Message](#14-mapping-between-oioxml-advis-and-fhir-carecommunication-messages)
...
### 1.4 Mapping between OIOXML Advis and FHIR CareCommunication Messages 
Mapping from previous OIOXML standards to the FHIR CareCommunication standard can be found below. The document is intended to help translate the previous standard to the new FHIR standard. Please notice that not all elements from  <a href="https://svn.medcom.dk/svn/releases/Standarder/Den%20gode%20korrespondance/XML/Dokumentation/" target="_blank">XDIS91</a>. are transferred to the CareCommunication, as not all elements are represented in the FHIR message. Furthermore, not all elements from the FHIR elements are represented in the document; thus, it cannot stand alone for implementation.
[Click here to see mapping from previous OIOXMLstandard to the FHIR CareCommunication .](assets/documents/Map_between_OIOXML_FHIR.md )
